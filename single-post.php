...
<?php 
  $imgBanner = '';
  foreach (wp_get_post_terms( get_post(  )->ID, $taxonomy = 'category') as  $value) {
    # code...
    $imgLink = get_term_meta($value->term_id, 'category_img', true );
...
$image = get_post_meta( $post->ID,'_detail_four_bottom',true );
...
<?php 	if(get_the_category($post->ID)[$key+1]){
                ...
                <div class="blog-thumb">
					<?php $link_image = get_post_meta( $post->ID, 'aw_custom_image', true );
                ...
                <div class="down-content">
                  ...
                  <!--  chỗ này điền link -->
                  <a href="#"><h2 style="font-weight:bold;"><?php the_title(); ?></h2></a>
                  <div id="fb-root"></div>
